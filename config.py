...
AUTH_CHANNEL = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('AUTH_CHANNEL', '-1002189546391').split()] # give channel id with seperate space. Ex : ('-10073828 -102782829 -1007282828')

# Bot Information
API_ID = int(environ.get("API_ID", "24139145"))
API_HASH = environ.get("API_HASH", "726096d9244efd78707cd468ef89d431")
BOT_TOKEN = environ.get("BOT_TOKEN", "7876298217:AAGwquyHVDuxZ2VI-MoLcv2JzAOMu9FdE-U")
...
BOT_USERNAME = environ.get("BOT_USERNAME", "Testajihabot") # without @
...
WEBSITE_URL = environ.get("WEBSITE_URL", "https://sonusx.blogspot.com/2024/09/store.html") # For More Information Check Video On Yt - @Tech_VJ
